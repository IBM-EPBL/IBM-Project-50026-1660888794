...
def sendemail(mail):
    message = Mail(
        ...
        html_content='<p>You have entered into a Covid Containment Zone!</p>'
                     '<p>Stay safe and maintain social distancing</p><br>'
                     '<p>Thank you</p><br>')
    try:
...
def send_conf_email(email):
    ...
    payload = {
        ...
        "htmlContent": "<p>Thank you for registering with us</p>"
